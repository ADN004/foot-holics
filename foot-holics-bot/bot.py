...
<head>
    ...
    <meta property="og:site_name" content="Foot Holics">
    ...
    <meta property="og:url" content="https://footholics.in/articles/{slug}.html">
...
<body>
    ...
    <div class="container" style="margin-top: 2rem;">
        <nav class="breadcrumbs" aria-label="Breadcrumb">
            ...
            <span class="breadcrumb-separator">&rsaquo;</span>
            <span aria-current="page">{_html.escape(title[:60])}</span>
        </nav>
    </div>

    <main id="main-content" class="container" style="margin-top: 2rem; max-width: 860px;">
        <article>
            <header style="margin-bottom: 2rem;">
                <div style="display: flex; gap: 0.75rem; align-items: center; flex-wrap: wrap; margin-bottom: 1rem;">
                    <span class="news-cat-badge">{_html.escape(category)}</span>
                    <time datetime="{date}" style="color: var(--muted); font-size: 0.85rem;">{date_display}</time>
                    <span style="color: var(--muted); font-size: 0.85rem;">By OnixWhite</span>
                </div>
                <h1 style="font-family: var(--font-heading); font-size: clamp(1.6rem, 4vw, 2.4rem); line-height: 1.2; letter-spacing: -0.01em; margin-bottom: 1.25rem;">{_html.escape(title)}</h1>
